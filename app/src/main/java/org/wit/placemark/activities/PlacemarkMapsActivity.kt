...
class PlacemarkMapsActivity : AppCompatActivity() , GoogleMap.OnMarkerClickListener{
    ...
    override fun onMarkerClick(marker: Marker): Boolean {
        ...
        if (placemark != null) {
            contentBinding.imageView.setImageURI(placemark.image)
        }
        //contentBinding.imageView.setImageBitmap(readImageFromPath(this@PlacemarkMapsActivity, placemark.image))
        return true
    }
